          ...
          <div className="card-body login-card-body">
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="social-auth-links text-center mb-3">
                ...
                <Link to={"/CrearCuenta"} className="btn btn-block btn-outline-info">
                  Crear cuenta
                </Link>

                <Link to={"/loginAdmin"} className="btn btn-block btn-outline-info">
                  Administrador
                </Link>

                <Link to={"/LoginVeterinario"} className="btn btn-block btn-outline-info">
                  Veterinario
                </Link>
              </div>
            </form>
